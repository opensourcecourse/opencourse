...
- Semantically used to mark a function
:::
...
arr_1 = map(random.randrange, itertools.repeat(10, 10))
```
...
arr_1 = [random.randrange(10) for _ in range(10)]
```
:::
...
rand_ints = (random.randrange(1000) for _ in range(10))
result = itertools.accumulate(rand_ints, max)
```
...
```{.python code-line-numbers="1||1-3|5-6"}
