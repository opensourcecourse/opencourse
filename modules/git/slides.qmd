...
# Git Graphs: Overview {.nostretch auto-animate="true"}
...
Add is simple. Add files to be saved, or add all.
...
Commit tells git to save the changes we added (staged). Add a message in the commit command
or an editor will open automatically.
...
Show can be used to see metadata about a commit
