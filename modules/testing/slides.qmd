...
- Edge cases checked (eg 0, -1 NaN, inf)
...
- The framework make valid changes to the code
- Runs the tests
...
- Marks can also skip/xfail based on conditions
:::
...
- --pdb flag stops after a test failure and drop into debugger
