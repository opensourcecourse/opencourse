...
```{.python code-line-numbers="|2-3|5-6|8|9"}
class Dog:
...
- If this still doesn't work consider methods named `get_x`/`set_x`.
:::
...
- MRO defines lookups (instance) -> (class) -> (parent) -> (grandparent) -> ...
